                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-card wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <form method="post" action="{{ route('reset.password.post') }}">
                                ...
                                <input type="password" placeholder="Enter new password" name="password" id="username">
                                @if ($errors->has('password'))
                                <span class="text-danger">{{ $errors->first('password') }}</span>
                                @endif

                                <label for="username">Confirm New Password</label>
                                <input type="password" placeholder="Confirm new password" name="password_confirmation" id="username">
                                ...
                                <p style="color: red;text-align: center;">
                                    Forgot Password? <span style="color:#000;">Click to reset</span>
                                </p>
